...
export default function Dashboard() {
  return (
    <main className="flex-grow p-4 md:p-8 w-full max-w-6xl mx-auto relative z-10 py-12">
      {/* Dashboard Header */}
      <div className="mb-10">
        <h2 className="text-4xl font-extrabold text-blue-950 drop-shadow-sm">Welcome back, Student!</h2>
        <p className="text-slate-700 font-medium mt-2 text-lg">You're making great progress in the <span className="text-orange-500 font-bold">Python Fullstack</span> bootcamp.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        ...
        <div className="lg:col-span-2 bg-white/60 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_0_rgba(31,38,135,0.05)] rounded-3xl p-8 hover:-translate-y-1 transition-all duration-300">
          <h3 className="text-2xl font-bold text-blue-950 mb-6">Current Module: Django ORM</h3>
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-700 font-bold">Bootcamp Progress</span>
            <span className="text-emerald-600 font-black text-xl">45%</span>
          </div>
          <div className="w-full bg-slate-200/80 rounded-full h-4 mb-8 overflow-hidden shadow-inner border border-white/40">
            <div className="bg-gradient-to-r from-emerald-400 to-emerald-500 h-4 rounded-full relative w-[45%]">
        ...
        <div className="bg-blue-950 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden border border-blue-800 flex flex-col justify-between hover:-translate-y-1 transition-all duration-300">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-2 relative z-10">Advanced Queries</h3>
            <p className="text-blue-200 font-medium mb-6 relative z-10">Today • 6:00 PM EST<br/>Mentored by David Chen</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[ { title: 'Python Fundamentals', status: 'Completed', color: 'bg-emerald-100/80 text-emerald-700 border-emerald-200', icon: '✓' }, { title: 'Web Frameworks', status: 'In Progress', color: 'bg-orange-100/80 text-orange-700 border-orange-200', icon: '▶' }, { title: 'APIs & Security', status: 'Locked', color: 'bg-white/40 text-slate-500 border-white/60', icon: '🔒' } ].map((module, i) => (
