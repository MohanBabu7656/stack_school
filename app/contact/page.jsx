      ...
      <div className="max-w-3xl w-full bg-white/60 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_0_rgba(31,38,135,0.05)] rounded-3xl p-4 md:p-8 lg:p-12 relative overflow-hidden">
        ...
        <div className="mt-12 flex flex-col items-center sm:items-start relative z-10">
          ...
          <a 
            ...
            className="group flex items-center gap-4 bg-white/40 hover:bg-white/60 border border-white/60 px-6 py-3 rounded-2xl transition-all duration-300 shadow-sm"
          >
            <div className="w-10 h-10 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] rounded-xl flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
            </div>
            <div>
              <p className="text-blue-950 font-bold text-sm">@stack.school</p>
              <p className="text-slate-500 text-xs font-medium">Join our community on Instagram</p>
            </div>
          </a>
        </div>
      </div>
