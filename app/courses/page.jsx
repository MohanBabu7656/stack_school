  ...
  return (
    <main className="flex-grow px-4 py-20 md:py-32 flex justify-center relative z-10">
      <div className="max-w-5xl w-full bg-white/30 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_0_rgba(31,38,135,0.06)] rounded-3xl p-8 md:p-12 relative overflow-hidden">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-blue-950 mb-12 drop-shadow-sm">Featured Stacks</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
          ...
          <div className="bg-white/60 backdrop-blur-md border border-white/60 shadow-lg rounded-2xl p-8 hover:shadow-orange-500/20 hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden flex flex-col h-full">
            ...
            <Link href="/courses/java" className="block text-center w-full py-3.5 bg-white/80 border-2 border-blue-950 text-blue-950 font-bold rounded-xl hover:bg-blue-950 hover:text-white transition-colors duration-300 shadow-sm mt-auto">Explore Java Stack</Link>
          </div>
